...
const DICT: Record<Lang, Dict> = {
  vi: {
    ...
    "adv.import": "Nhập CSV", "adv.importTemplate": "Tải mẫu", "adv.importDone": "Đã nhập {n} sinh viên", "adv.importFail": "{n} dòng lỗi",
  ...
  en: {
    ...
    "adv.import": "Import CSV", "adv.importTemplate": "Template", "adv.importDone": "Imported {n} students", "adv.importFail": "{n} rows failed",
