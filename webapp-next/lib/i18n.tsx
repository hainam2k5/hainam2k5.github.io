...
const DICT: Record<Lang, Dict> = {
  vi: {
    ...
    "nav.alerts": "Cảnh báo & Can thiệp", "nav.messages": "Tin nhắn", "nav.evaluation": "Đánh giá", "nav.attendance": "Điểm danh", "nav.grades": "Nhập điểm", "nav.classes": "Lớp học",
    "cls.title": "Lớp học", "cls.sub": "Điểm danh & ghi điểm cho lớp bạn dạy", "cls.tabAttend": "Điểm danh", "cls.tabGrades": "Ghi điểm", "cls.weeklyNote": "Mỗi tuần 1 buổi học", "cls.titleAttend": "Điểm danh", "cls.subAttend": "Điểm danh theo buổi cho lớp bạn dạy", "cls.titleGrades": "Nhập điểm", "cls.subGrades": "Nhập điểm thành phần TX/GK/CK cho lớp bạn dạy", "cls.pickClass": "Chọn lớp", "cls.selectClass": "— Chọn lớp —", "cls.noClasses": "Bạn chưa được phân công lớp nào.", "cls.session": "Buổi ngày", "cls.noStudents": "Chưa có sinh viên nào trong lớp này (cần có bản ghi điểm khớp Mã môn + Học kỳ).", "cls.present": "Có mặt", "cls.attRate": "Chuyên cần", "cls.saveAttend": "Lưu điểm danh", "cls.attHint": "Tick = có mặt. Lưu sẽ tự cập nhật tỷ lệ chuyên cần của sinh viên.", "cls.saveGrades": "Lưu điểm", "cls.weightsNote": "Trọng số: TX {r} · GK {m} · CK {f}", "cls.attErr": "Không lưu được điểm danh.", "cls.attSaved": "Đã lưu điểm danh", "cls.gErr": "Điểm phải trong khoảng 0–10.", "cls.gSaved": "Đã lưu điểm",
    ...
    "notif.gradeBodyDetailed": "Điểm môn {course} vừa được cập nhật: TX {r} · GK {m} · CK {f} → Tổng {total} ({letter}).",
    ...
    "card.riskDist": "Phân bố mức rủi ro", "riskdist.hint": "Bấm vào một mức để lọc danh sách sinh viên",
    "adv.studentInfo": "Thông tin sinh viên", "adv.contactEmail": "Email liên hệ", "card.chatStudent": "Trao đổi với sinh viên",
    "adv.import": "Nhập Excel", "adv.importTemplate": "Tải mẫu", "adv.importDone": "Đã tạo {n} tài khoản sinh viên", "adv.importFail": "{n} dòng lỗi",
    "adv.batchPasswordPrompt": "Nhập mật khẩu khởi tạo chung cho các sinh viên chưa có cột 'password' (tối thiểu 6 ký tự):",
    "adv.importGrades": "Nhập điểm (Excel)", "adv.gradeTemplate": "Tải mẫu điểm", "adv.exportReport": "Xuất báo cáo",
    ...
    "gb.lockedSkip": "{n} dòng đã khóa (bỏ qua)", "toast.courseLocked": "Điểm môn này đã bị khóa.",
    "sum.h10": "Điểm trung bình tích lũy (hệ 10)", "sum.h4": "Điểm trung bình tích lũy (hệ 4)", "sum.credits": "Tổng số tín chỉ tích lũy",
    "legend.formula": "Điểm tổng môn = TX×wTX + GK×wGK + CK×wCK (trọng số mặc định 0.2 / 0.3 / 0.5, lưu theo từng môn).",
    "legend.scale": "Thang điểm chữ (hệ 10 → hệ 4)",
    ...
    "adv.secOverview": "Tổng quan nhanh", "adv.secAnalytics": "Phân tích",
    ...
    "adv.allCohorts": "Tất cả khóa", "adv.allSemesters": "Tất cả học kỳ", "adv.clearFilters": "Xóa lọc", "adv.matchCount": "Hiển thị {n}/{total} sinh viên",
    ...
    "whatif.title": "Mô phỏng cải thiện điểm", "whatif.sub": "Thử điểm chữ tốt hơn — xem CPA & rủi ro đổi ngay (không lưu)",
    "whatif.pickHint": "Bấm chọn điểm mong muốn cho môn định học cải thiện; bấm lại để bỏ chọn.", "whatif.noCourses": "Chưa có môn nào có điểm để mô phỏng.",
    "whatif.riskScore": "Điểm rủi ro", "whatif.reset": "Xóa mô phỏng", "whatif.escape": "thoát vùng báo động",
    "whatif.targetTitle": "Mục tiêu xếp loại tốt nghiệp", "whatif.totalCredits": "Tổng tín chỉ chương trình", "whatif.remaining": "còn lại {n} tín chỉ",
    "whatif.needAvg": "cần TB phần còn lại ≥ {v}", "whatif.reached": "nền hiện tại đã đủ", "whatif.impossible": "cần > 4.0 — không thể đạt", "whatif.done": "đã học đủ tín chỉ",
    "whatif.rank.kha": "Khá (CPA ≥ 2.5)", "whatif.rank.gioi": "Giỏi (CPA ≥ 3.2)", "whatif.rank.xs": "Xuất sắc (CPA ≥ 3.6)",
    ...
    "adv.alertsTitle": "Cảnh báo & Can thiệp", "adv.alertsSub": "Xử lý cảnh báo và theo dõi nhật ký can thiệp", "adv.otherAdvisor": "Cố vấn khác", "empty.noAlertsStatus": "Không có cảnh báo ở trạng thái này.",
  ...
  en: {
    ...
    "nav.alerts": "Alerts & Interventions", "nav.messages": "Messages", "nav.evaluation": "Evaluation", "nav.attendance": "Attendance", "nav.grades": "Grades", "nav.classes": "Classes",
    "cls.title": "Classes", "cls.sub": "Attendance & grades for the classes you teach", "cls.tabAttend": "Attendance", "cls.tabGrades": "Grades", "cls.weeklyNote": "One session per week", "cls.titleAttend": "Attendance", "cls.subAttend": "Take per-session attendance for the classes you teach", "cls.titleGrades": "Grades", "cls.subGrades": "Enter TX/GK/CK component grades for the classes you teach", "cls.pickClass": "Pick a class", "cls.selectClass": "— Select class —", "cls.noClasses": "You have no classes assigned yet.", "cls.session": "Session date", "cls.noStudents": "No students in this class yet (needs grade records matching the course code + semester).", "cls.present": "Present", "cls.attRate": "Attendance", "cls.saveAttend": "Save attendance", "cls.attHint": "Ticked = present. Saving updates each student's attendance rate automatically.", "cls.saveGrades": "Save grades", "cls.weightsNote": "Weights: Reg {r} · Mid {m} · Final {f}", "cls.attErr": "Couldn't save attendance.", "cls.attSaved": "Attendance saved", "cls.gErr": "Scores must be between 0 and 10.", "cls.gSaved": "Grades saved",
    ...
    "notif.gradeBodyDetailed": "Grade for {course} updated: Reg {r} · Mid {m} · Final {f} → Total {total} ({letter}).",
    ...
    "card.riskDist": "Risk level distribution", "riskdist.hint": "Click a level to filter the student list",
    "adv.studentInfo": "Student info", "adv.contactEmail": "Contact email", "card.chatStudent": "Chat with student",
    "adv.import": "Import Excel", "adv.importTemplate": "Template", "adv.importDone": "Created {n} student accounts", "adv.importFail": "{n} rows failed",
    "adv.batchPasswordPrompt": "Enter a shared initial password for students without a 'password' column (at least 6 characters):",
    "adv.importGrades": "Import grades (Excel)", "adv.gradeTemplate": "Grade template", "adv.exportReport": "Export report",
    ...
    "gb.lockedSkip": "{n} locked rows skipped", "toast.courseLocked": "This course's grades are locked.",
    "sum.h10": "Cumulative average (10-point)", "sum.h4": "Cumulative average (4-point)", "sum.credits": "Total credits earned",
    "legend.formula": "Course total = TX×wTX + GK×wGK + CK×wCK (default weights 0.2 / 0.3 / 0.5, stored per course).",
    "legend.scale": "Letter scale (10-point → 4-point)",
    ...
    "adv.secOverview": "At a glance", "adv.secAnalytics": "Analytics",
    ...
    "adv.allCohorts": "All cohorts", "adv.allSemesters": "All semesters", "adv.clearFilters": "Clear filters", "adv.matchCount": "Showing {n}/{total} students",
    ...
    "whatif.title": "Grade improvement simulator", "whatif.sub": "Try better letter grades — see CPA & risk change instantly (nothing saved)",
    "whatif.pickHint": "Click a target grade for a course you might retake; click again to clear.", "whatif.noCourses": "No graded courses to simulate yet.",
    "whatif.riskScore": "Risk score", "whatif.reset": "Clear simulation", "whatif.escape": "leaves the alarm zone",
    "whatif.targetTitle": "Degree classification target", "whatif.totalCredits": "Program total credits", "whatif.remaining": "{n} credits remaining",
    "whatif.needAvg": "need ≥ {v} avg on the rest", "whatif.reached": "already on track", "whatif.impossible": "needs > 4.0 — unreachable", "whatif.done": "all credits completed",
    "whatif.rank.kha": "Good (CPA ≥ 2.5)", "whatif.rank.gioi": "Very good (CPA ≥ 3.2)", "whatif.rank.xs": "Excellent (CPA ≥ 3.6)",
    ...
    "adv.alertsTitle": "Alerts & Interventions", "adv.alertsSub": "Handle alerts and review the intervention log", "adv.otherAdvisor": "Another advisor", "empty.noAlertsStatus": "No alerts in this status.",
